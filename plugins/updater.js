...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/BLOOD-MAIN/Blood-XMD-C-/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/BLOOD-MAIN/Blood-XMD-C-/archive/refs/heads/main.zip", { responseType: "arraybuffer" });
